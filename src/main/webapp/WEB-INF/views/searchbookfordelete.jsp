		 	  		...
		 	  		<div class="col-md-2">
			  	  	...
			  	  	<div class="col-md-10">			  			
					  		...
					  		<div class="form-container">
					  			...
					  			<h2>Search a Book To Delete</h2>
					  			
					  			<br/>
					  			
					  			<jsp:include page="message.jsp"/>
					  			
					  			<form:form action="${pageContext.request.contextPath}/books/deletebooksearch" modelAttribute="criteria" class="form-inline">
					  			...
					  			<jsp:include page="deletebooksearchresults.jsp"/>	  				  			
